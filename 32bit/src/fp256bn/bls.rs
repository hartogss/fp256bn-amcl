...
use crate::fp256bn::ecp;
use crate::fp256bn::ecp::ECP;
use crate::fp256bn::dbig::DBIG;
use crate::fp256bn::ecp2::ECP2;
//use crate::fp256bn::fp4::FP4;
use crate::fp256bn::pair;
...
pub fn bls_hash_to_point(m: &[u8]) -> ECP {
    let dst= "BLS_SIG_FP256BNG1_XMD:SHA-256_SVDW_RO_NUL_";
